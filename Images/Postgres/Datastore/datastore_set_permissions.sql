...
REVOKE CONNECT ON DATABASE "ckan" FROM "ckan_datastore";

-- grant select permissions for read-only user
GRANT CONNECT ON DATABASE "ckan" TO "ckan_datastore";
...
ALTER DEFAULT PRIVILEGES FOR USER "ckan" IN SCHEMA public
   GRANT SELECT ON TABLES TO "ckan_datastore";
...
GRANT SELECT ON "_table_metadata" TO "ckan_datastore";
